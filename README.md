...
1. [Create a new GitHub repository](https://github.com/new?template_name=buildkite-agentic-github-pr-review&template_owner=cnunciato) using this repository as a template.
